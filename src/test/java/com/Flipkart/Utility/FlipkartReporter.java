...
public class FlipkartReporter extends FlipkartReporterListener
{

	private static final Logger L = Logger
			.getLogger(FlipkartReporterListener.class);
	...
	public void startResultSummaryTable(String style) { 
		...
		m_out.println("<tr><td colspan='5'>Overall test suite completion : <b>"
				...
				+ sdf.format(date) + "</b><br/> Browser : <b>"+SeleniumInit.Testbrowser+"<t></t>"
				+ System.getProperty("os.name") + "</b><br/>Tested URL: <b>"
				+ SeleniumInit.TestURL);
	...
	protected void endHtml(PrintWriter out) {
		out.println("<tr bgcolor='SkyBlue'><td align='right' colspan='5'><center><b><i>Report customized by Jaykishan </i><b><center></center></b></b></center></td></tr>");
